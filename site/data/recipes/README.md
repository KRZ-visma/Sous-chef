...
One **JSON file per recipe**, served with the GitHub Pages site under `site/data/recipes/`. No database: recipes are versioned in Git and loaded by the app with `fetch()` (same origin).
